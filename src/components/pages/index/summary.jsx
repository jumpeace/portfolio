...
export default function Summary({summaryItems}) {
    return (
        <div className="py-8 md:py-12 flex">
            ...
            <div className="flex-initial justify-center items-center flex flex-col gap-y-4 md:gap-y-6 bg-white">
                {/* 概要の項目群のループ */}
                {summaryItems.map(summaryItem => (
                    <div key={summaryItem.key} className="flex flex-col gap-y-1">
                        {/* 項目 */}
                        <div className="flex justify-center items-center gap-x-3">
                            <FontAwesomeIcon icon={summaryItem.icon} cla1ssName="w-6 h-6 text-gray-700" />
