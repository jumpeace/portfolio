...
export default function SkillGenre({prop}) {
    return (
        <div key={prop.title} className={`flex py-8 md:py-16 lg:py-20 bg-${prop.bgColor}`}>
            ...
            <div className="flex-initial flex flex-col gap-y-4 md:gap-y-6">
                <div className="flex gap-x-3 md:gap-x-4 lg:gap-x-6 items-center">
                    <FontAwesomeIcon icon={prop.icon} className="text-gray-500 text-3xl lg:text-4xl" />
                    <div className="text-gray-600 text-2xl md:text-3xl lg:text-4xl tracking-wider font-light">{prop.title}</div>
                </div>
