        ...
        <div key={skillGenre.title} className={`flex py-8 md:py-16 lg:py-20 bg-${skillGenre.bgColor}`}>
            ...
            <div className="flex-initial flex flex-col gap-y-4 md:gap-y-6">
                <div className="flex gap-x-3 md:gap-x-4 lg:gap-x-6 items-center justify-center">
                    <FontAwesomeIcon icon={skillGenre.icon} className="text-gray-500 text-2xl md:text-4xl" />
                    <div className="text-gray-600 text-xl md:text-3xl tracking-wider font-light">{skillGenre.title}</div>
                </div>
                <div className="mx-16 max-w-[1156px] flex flex-wrap gap-x-2 gap-y-2 md:gap-y-4">
                    {skillGenre.skills.map((skill) => (
                        <div key={skill.title} className="flex flex-col gap-y-1 md:gap-y-2 items-center px-2">
                            <FontAwesomeIcon icon={skill.icon} className="w-[48px] h-[48px] md:w-[80px] md:h-[80px] text-gray-400" />
